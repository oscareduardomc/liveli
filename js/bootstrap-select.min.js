    ...
    !(function(T) {
        ...
        (te.prototype = {
            ...
            setPositionData: function() {
                ...
                for (
                    var e = 0; e < this.selectpicker.current.data.length; e++
                ) {
                    ...
                    "divider" === t.type ?
                        ...
                        (this.selectpicker.view.size++,
                            (t.posinset = this.selectpicker.view.size), !1 ===
            ...
            buildData: function(p, e) {
                ...
                function w(e, t) {
                    if (
                        (((t = t || {}).divider = u(e, "divider")), !0 === t.divider)
                    )
                        b({
                            optID: t.optID,
                        });
            ...
            liHeight: function(e) {
                if (
                    ...
                    if (
                        ...
                        for (
                            var m = 0; m < this.selectpicker.current.data.length; m++
                        ) {
                ...
                this.$button.on("click.bs.dropdown.data-api", function() {
                        l.isDisabled() ||
                            (e(l.$newElement),
                                ...
                                .toggleClass(
                                    G.SHOW, !l.$button.hasClass(G.SHOW)
                                )
                                .append(l.$menu));
                    }),
                    T(window)
                    ...
                    this.$searchbox.on("input propertychange", function() {
                        ...
                        if (
                            ...
                            if (u.options.source.search)
                                ...
                                l && (i = I(i));
                                for (
                                    var r = 0; r < u.selectpicker.main.data.length; r++
                                ) {
                ...
                if (!(112 <= e.which && e.which <= 123))
                    if (!(i = a.$menu.hasClass(G.SHOW)) &&
                        ...
                        if (
                            ...
                            for (
                                var w = 0; w < a.selectpicker.current.data.length; w++
                            ) {
