...
!(function(t, i) {
    ...
    class d {
        ...
        setDisplayedSize(t, s) {
            if (
                this.element &&
                (this.placeholder && this.placeholder.setDisplayedSize(t, s), !this.instance.dispatch("contentResize", {
                        content: this,
                        width: t,
                        height: s,
                    }).defaultPrevented &&
    ...
    return class extends class extends class {
        ...
        preload(t, i) {
            ...
            var n;
            ("function" == typeof s.openPromise && h.push(s.openPromise()), !1 !== s.preloadFirstSlide &&
                t >= 0 &&
                (this._ = (function(t, i) {
        ...
        I(t, i) {
            ...
            ((this.pswp = s),
                ...
                this._ &&
                (s.contentLoader.addToCache(this._), (this._ = void 0)),
                s.on("destroy", () => {
