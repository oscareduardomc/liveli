...
!(function(t, i) {
    ...
    class b {
        ...
        calculateSize() {
            ...
            (i(
                    this.panAreaSize,
                    y(t.options, t.viewportSize, this.data, this.index),
                ),
    ...
    class S {
        ...
        change() {
            ...
            if (
                ...
                this.M("x") ||
                    (this.M("y"), e && (s(e.pan), e.applyCurrentZoomPan()));
            }
        }
        end() {
            const {
            ...
            (s && s.currZoomLevel > s.zoomLevels.max) ||
            this.gestures.isMultitouch ?
        ...
        M(t) {
            ...
            if (
                ...
                ("y" === t && (o.isShifted() || l.min.y === l.max.y)) ||
                this._(t, c);
            return !1;
        }
        S(t) {
            ...
            (s.animations.stopAllPan(),
                s.animations.startSpring({
                    ...
                    onUpdate: (t) => {
                        ...
                        c &&
                            s.bgOpacity < 1 &&
                            s.applyBgOpacity(n(l + (1 - l) * t, 0, 1));
                    },
                    onComplete: () => {
                    ...
                    switch (r) {
                        ...
                        case "zoom-or-close":
                            null != n &&
                                ...
                                n.toggleZoom(i) :
                                e.options.clickToCloseNonZoomable &&
                                e.close();
                            break;
    ...
    class W {
        ...
        At() {
            ...
            if (
                (this.pswp.opener.isOpen || (h = i.zoomLevels.initial),
                    h === this.Tt)
            )
                return;
            this.Tt = h;
            ...
            if (this.slide && this.usePlaceholder())
                if (this.placeholder) {
                    ...
                    const t = this.instance.applyFilters(
                        "placeholderSrc", !(!this.data.msrc || !this.slide.isFirstSlide) &&
                        this.data.msrc,
                        this,
                    );
    ...
    class it {
        ...
        Vt() {
            ...
            ("fade" === s.showHideAnimationType ?
                ...
                this.$t) ?
            (this.kt =
                null !== (h = s.showHideOpacity) && void 0 !== h && h) :
            ((this.kt = !0),
                this.isOpening &&
                i &&
